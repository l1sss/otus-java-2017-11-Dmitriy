...
public class MemoryUtil {
    ...
    private static NotificationListener gcHandler = new NotificationListener() {
        ...
        public void handleNotification(Notification notification, Object handback) {
            if (notification.getType().equals(GarbageCollectionNotificationInfo.GARBAGE_COLLECTION_NOTIFICATION)) {
                ...
                totalGCcount++;
                totalGCduration += gcInfo.getGcInfo().getDuration();
            }
        }
    };
    ...
    /**
     * Выводит в stdout информацию о количестве всех сборок и итоговом времени работы GC
     */
    public static void printTotal() {
        System.out.println("Total GC count: " + totalGCcount + ", total duration: " + totalGCduration + " ms");
    }
